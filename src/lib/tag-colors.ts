...
/**
 * Valid size range tag names (must match convex/utils/tag_categories.ts)
 */
const SIZE_RANGE_TAGS = [
  'Tiny',
  'Small',
  'Medium',
  'Large',
 ...
 * This function must match the logic in convex/utils/tag_categories.ts
 */
